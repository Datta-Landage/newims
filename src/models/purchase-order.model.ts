...
export interface IPurchaseOrder extends Document {
  ...
  totalAmount: number;
  rtvCredit?: number; // Amount deducted
  linkedRtvId?: mongoose.Types.ObjectId | null; // The RTV used for credit
  masterCreationFlags?: {
    addToVendorMaster: boolean;
    addToInventoryMaster: boolean;
  };
  tempVendorData?: {
...
const PurchaseOrderSchema = new Schema<IPurchaseOrder>(
  {
    ...
    rtvCredit: { type: Number, default: 0 },
    linkedRtvId: { type: Schema.Types.ObjectId, ref: 'RTV', default: null },
    masterCreationFlags: {
      addToVendorMaster: { type: Boolean, default: false },
      addToInventoryMaster: { type: Boolean, default: false }
    },
    tempVendorData: {
...
PurchaseOrderSchema.index({ tenantId: 1, displayId: 1 }, { unique: true });
